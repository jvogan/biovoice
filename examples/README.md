...
- `chimerax-em-map-fit-demo` | **Cryo-EM Map Fit Review** | Open a real local cryo-EM map with its fitted hemoglobin model, inspect mesh and orthoplanes, report the fit quality, and export a polished map-fit still.
